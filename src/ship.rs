//! Fleet systems and strategic commands.
//!
//! This module contains the systems that operate on fleets.
//! Pure data types (Fleet, FlightPlan, etc.) are in `model/fleet.rs`.
...
// ============================================================================
// Rendering Components (strategic-only, not in model/)
// ============================================================================
